...
| Periodicals OCR 2010-2021 |  These are tricky since the quality varies a lot. We are considering if we are going to reprecess this to increase quality and size. |0 | More than 1.9 |
...
| 3 | Cleaned text. Text is cleaned and evaluated before this step. Paragraphs is removed here, and segments of up to 1000 words are separated by linebreaks. In ve2 is this format also jsonl but without paragraphs.|
