...
def parse_args():
    ...
    parser.add_argument('--source_filter', required=True,
                        help='Filter the source based on pattern. Input for instance \"maalfrid\" to look only at the maalfrid related sources. To look at all sources, use the other script. ')
