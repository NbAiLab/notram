...
if __name__ == '__main__':
    ...
    if (fileexists(filelistfile) == False):
        ...
        exit(-1)
    if (fileexists(outputdir + "/aggregatedindex.aidx") == False):
        printwithtime("Aggregated index file does not exist for dir: " + outputdir + "/aggregatedindex.aidx")
        exit(-1)
    ...
    aggdict = {}
    printwithtime("Start reading Aggregated dictionary : " + outputdir + "/aggregatedindex.aidx")
    aggdict=readpickledFile(outputdir + "/aggregatedindex.aidx")
