####################################################################################
# Convert the downloaded Wikipedia files to our jsonl.
    ...
    with jsonlines.open(args.output_file, 'w') as writer:
            with jsonlines.open(args.input_file) as reader:
                for wikipost in tqdm(reader):
                    ...
                    myarticle['id'] = args.doc_type+"_"+ wikipost['title']+"_"+str(n) 
...
def parse_args():
    ...
    parser.add_argument('--language_reported', required=False, default="N/A", type=str, help='Language reported. Can be nob, nno, no, da, sv, is or N/A')
    parser.add_argument('--doc_type', required=True, type=str, help='For instance wikipedia_download_no')
