    ...
    with jsonlines.open(args.output_file, 'w') as writer:
        ...
        for input_file in tqdm(files):
            with open(input_file) as f:    
                ...
                myarticle['id'] = "maalfrid_"+content_hash+"_"+str(current_page)
...
def parse_args():
    ...
    parser.add_argument('--doc_type', required=True, type=str, help='For instance maalfrid')
    parser.add_argument('--input_folder', required=True, type=str, help='Input folder')
    parser.add_argument('--meta_file', required=True, type=str, help='Meta file from Språkbanken in csv format')
