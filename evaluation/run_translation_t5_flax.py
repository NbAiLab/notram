...
class ExtraArguments:
    ...
    learning_rate_end: Optional[float] = field(
        default=None, metadata={"help": "Learning rate end for linear decay."}
    )
    learning_rate_is_constant: bool = field(
        default=False, metadata={"help": "Is learning rate constant?"}
    )
...
def create_learning_rate_fn(
    train_ds_size: int, train_batch_size: int, num_train_epochs: int, num_warmup_steps: int, learning_rate: float, learning_rate_end: float=0.0,
...
def main():
    ...
    if extra_args.learning_rate_is_constant:
        learning_rate_end = training_args.learning_rate
    elif extra_args.learning_rate_end is not None:
        learning_rate_end = extra_args.learning_rate_end
    else:
        learning_rate_end = 0
